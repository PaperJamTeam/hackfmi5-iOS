...
@interface CAFURLConnectionOperation () <NSURLConnectionDataDelegate>
...
// NOTE: We reimplement this because the CAFNetworking implementation keeps Acceptable Status Code/MIME Type at class level
- (NSError *)error
{
    [self.lock lock];
...
{
    if ([CAFHTTPRequestOperation instancesRespondToSelector:@selector(connection:willSendRequest:redirectResponse:)]) {
