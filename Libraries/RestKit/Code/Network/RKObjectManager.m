...
- (instancetype)initWithHTTPClient:(CAFHTTPClient *)client
{
    self = [super init];
    if (self) {
...
{
    RKObjectManager *manager = [[self alloc] initWithHTTPClient:[CAFHTTPClient clientWithBaseURL:baseURL]];
    [manager.HTTPClient registerHTTPOperationClass:[CAFJSONRequestOperation class]];
...
/**
 This method is the `RKObjectManager` analog for the method of the same name on `CAFHTTPClient`.
 */
                                ...
                                parameters:(NSDictionary *)parameters
{
    ...
    if (parameters && !([method isEqualToString:@"GET"] || [method isEqualToString:@"HEAD"] || [method isEqualToString:@"DELETE"])) {
        ...
        NSDictionary *parametersForClient = [self.HTTPClient isMemberOfClass:[CAFHTTPClient class]] ? nil : parameters;
...
- (void)copyStateFromHTTPClientToHTTPRequestOperation:(CAFHTTPRequestOperation *)operation
{
