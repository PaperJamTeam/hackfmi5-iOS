...
@interface RKTestAFHTTPClient : CAFHTTPClient
@end
...
{
    CAFHTTPClient *client = [CAFHTTPClient clientWithBaseURL:[NSURL URLWithString:@"http://restkit.org"]];
...
{
    RKObjectManager *manager = [RKObjectManager managerWithBaseURL:[NSURL URLWithString:@"http://restkit.org"]];
    manager.HTTPClient = [CAFHTTPClient clientWithBaseURL:[NSURL URLWithString:@"http://google.com/"]];
